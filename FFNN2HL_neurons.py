...
if nm:
    ...
    TestModel = K.models.load_model(str(nl) + 'hl_v'+str(mv))
    #TestModel.summary()
...
#############################################################
'''
data = [nl, rel_RMSE, neuron1, neuron2, neuron3]
from csv import writer
with open('RMSE_layers.csv', 'a') as f_object:
...
Model1Perfo.to_csv(str(nl) + 'hl_v'+str(mv) + '_perfo.csv', header=['Value'])
